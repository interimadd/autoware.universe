...
使い方：
ros2 launch autoware_default_adapi_poc poc_relay_standalone_nodes.launch.py topic_num:=10
"""
...
def generate_launch_description():
    ...
    def launch_setup(context, *args, **kwargs):
        ...
        nodes = [
            generate_poc_relay_standalone_nodes(i) for i in range(1, topic_num + 1)
        ]
        nodes += [
